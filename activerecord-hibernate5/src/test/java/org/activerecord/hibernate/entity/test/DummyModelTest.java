...
public class DummyModelTest extends ModelBaseTest {
	...
	public void testExample() {
		...
		System.out.println("1111111111111111111111111>>>>>"+dummyModelExample);
	...
	private DummyModel createDummyModel(final String id) {
		...
		if (!exist) {
			...
			dummyModel.setColumn2("Column2");
			dummyModel.setColumn3("Column3");
			dummyModel.setDate(new Date());
			dummyModel.setTime(new Date());
			dummyModel.setTimestamp(new Date());
			dummyModel.save();
			...
			dummyParent.setDate(new Date());
			dummyParent.setTime(new Date());
			dummyParent.setTimestamp(new Date());
			dummyParent.save();

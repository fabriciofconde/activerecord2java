...
public class PropertyUtil {
	...
	public static Class<?> getCollectionElementType(Type type) {
		...
		try {
			...
			logger.log(Level.WARNING, "Failed while getting the collection element type", e);
		}
		return Object.class;
	}
	...
	public static Object getProperty(Object bean, String name) {
		try {
			...
			if (e.getCause() instanceof NoSuchMethodException) {
				logger.log(Level.FINEST, "Getter doesn't exist for the property {} in the class {}", new Object[] { name, bean.getClass() });
				return null;
			}
